...
<?php 
	...
	echo str_replace( '&', '&amp;', do_shortcode( Codevz::option( 'body_codes' ) ) );
	...
	$cover_image = Codevz::option( 'page_cover_image' . $option_cpt );
